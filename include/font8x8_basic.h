...
uint8_t font8x8_basic_tr[128][8] = {
    ...
    { 0x08, 0x04, 0x02, 0x01, 0x01, 0x02, 0x84, 0x78 },   // U+003D (HEART right top) =
    { 0x20, 0x10, 0x08, 0x04, 0x02, 0x01, 0x00, 0x00 },   // U+003E (HEART right bottom) >
    { 0x00, 0x00, 0x00, 0x01, 0x02, 0x04, 0x08, 0x10 },   // U+003F (HEART left bottom) ?
    { 0x38, 0x44, 0x82, 0x01, 0x01, 0x01, 0x02, 0x04 },   // U+0040 (HEART left top) @
